...
# Visualiza las operaciones en la pantalla
...
# Configuración básica de la calculadora

ventana=Tk()
ventana.title("Mirror's Calcu")
...
# Configurar  La pantalla de nuestra calculadora
